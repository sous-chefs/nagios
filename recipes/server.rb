...
esp_us_east_count = esp_us_east.count
esp_eu_west_count = esp_eu_west.count
esp_eu_central_count = esp_eu_central.count
...
dd_eu_central_count = dd_eu_central.count
dd_us_east_count_double = dd_us_east_count * 2
...
Chef::Log.warn("Second App_Environment is: #{environment}")
  ...
  nagios_conf "services" do
    variables(
      ...
      :vp_us_east_count => vp_us_east_count,
      ...
      :au_us_east_count => au_us_east_count,
      :au_eu_central_count => au_eu_central_count,
      :au_eu_west_count => au_eu_west_count,
